...
//Passing values to functions as parameters
function functionAdd(a, b) {
    console.log("The result of adding two numbers is " + (a+b));
}
functionAdd(5, 10)

//Global scope and Functions - visibility of variables, variables defined outside function have global scope while defined inside function are scoped within that particular function
var myGlobal = 10;
function fun1() {
    oopsGlobal = 5;
}
...
//Global vs Local scope - local scope takes precedence
...
console.log(myOutFit()); // Here Sweater is printed
...
//console.log(addThree()) //Get Sum is not defined error

function addFive() {
Sum += 5;
}

//console.log(addFive()); //get sum is not defined error
//
...
//Boolean Values - Another datatype
...
console.log(welcomeToBooleans(5))
console.log(welcomeToBooleans(11))

// Use conditional logic with Id statements
var isItTrue = 2==3;
